...
### Validated (v1.0 — all phases complete, 2026-05-24)

- [x] 用户可以从题库中选择题目的组合进行模拟面试 — Phase 1
- [x] 模拟真实面试流程：问好入座 → 听题/看题 → 思考作答 → 结束 — Phase 2
- [x] 每道题有限时作答（思考 1-2 分钟 + 答题 2-3 分钟），考生语音回答 — Phase 3
- [x] 题目逐题进行，全部作答后统一评分 — Phase 3
- [x] 基于已有评分要点（score_points）对比考生回答内容进行打分和反馈 — Phase 4
- [x] 数字人考官（静态图/简单动图）念出题目，用户可切换是否显示题目文本 — Phase 2
